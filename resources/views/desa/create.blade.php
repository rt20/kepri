                ...
                <div>
                    ...
                    <form class="w-full" action="{{ route('desa.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('idprov') }}" name="idprov" require
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('provinsi') }}" name="provinsi" require
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('idkab') }}" name="idkab" require
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('kabkota') }}" name="kabkota" require
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('idkec') }}" name="idkec" require
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('kecamatan') }}" name="kecamatan" require
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('iddesa') }}" name="iddesa" require
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('desa') }}" name="desa" require
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
